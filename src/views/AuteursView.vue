<template>
  ...
  <div class="row">
        ...
        <form>
          <div class="form-group">
            ...
            <input
              ...
              v-model="formAuteur.nom"
            />
          </div>
          <button
            type="button"
            class="btn btn-success"
            v-on:click="submitFormAuteur"
      ...
      <form>
        <div class="form-group">
          <input
            ...
            class="form-control"
            id="exampleFormControlInput1"
            placeholder="Recherche d'un auteur par nom..."
            v-model="search"
          />
        </div>
      </form>
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="auteur in filteredAuteur" v-bind:key="auteur.idauteur">
              ...
              <td>
                <div
                  v-on:click="toggleModale(auteur)"
              ...
              <td>
                <button
                  v-on:click="deleteAuteurList(auteur.idauteur)"
                  type="submit"
    ...
    <ModaleAuteur
      ...
      :idauteur="upAuteur.idauteur"
      :nomAuteur="upAuteur.nom"
      :prenomAuteur="upAuteur.prenom"
    />
  </div>
</template>
...
export default {
  ...
  methods: {
    async getAuteurs() {
      await axios
        .get("https://bookstore-depository-2.herokuapp.com/auteur")
        .then((response) => {
